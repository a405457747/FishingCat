...
public enum Transition
{
    ...
    ClickStartArea,//点击了开始钓鱼的触发区域
    HookToTarget,//鱼钩到达目的地
    AchieveToDrawIn,//达到收网的条件了
    HasBeenCollectedMoney,//已经收钱了
}
...
public enum StateID
{
    ...
    WaitLoad,//等待加载数据
    GameStart,//游戏开始   快速落下钩子
    FishingCtrl,//鱼竿操纵 左右摇晃 慢速回钩子
    FishingFinish//收鱼竿 自动修正鱼竿快速回钩子，结算保存哦
}
